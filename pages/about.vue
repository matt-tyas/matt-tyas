  ...
  <main>
    <section class="mt-box mt-box--about mt-box--full mt-box--about--is-open">
        <div class="mt-grid-container">
          <header class="mt-introduction mt-introduction--about">
            <h1 class="mt-title">
              Matt Tyas
            </h1>
          ...
          <article class="mt-about-content mt-about-content--is-open mt-about-content--top">
            <h3>About me</h3>
            <p>
